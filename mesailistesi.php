...
$sorguindex = $baglanti->query("SELECT * FROM mesailer_2022");
...
<head>
  ...
  <title>Personel Mesai Bilgileri</title>
</head>
<body>
...
<table style="margin-left: 5%;">
  ...
  <tr>
    ...
    <?php $toplamgelir=$ciktiper['ocak']+$ciktiper['subat']+$ciktiper['mart']+$ciktiper['nisan']+$ciktiper['mayis']+$ciktiper['haziran']+$ciktiper['temmuz']+$ciktiper['agustos']+$ciktiper['eylul']+$ciktiper['ekim']+$ciktiper['kasim']+$ciktiper['aralik']; ?>
    <td><?=$toplamgelir*22.5?></td>
  </tr>
<?php } ?>
